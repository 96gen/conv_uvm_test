...
$cases = @(
  ...
  [pscustomobject]@{ Group = "Dataset";    Key = "zero_dataset";             Name = "zero dataset golden compare" },
  [pscustomobject]@{ Group = "Dataset";    Key = "high_value_dataset";       Name = "high-value dataset path" },
  [pscustomobject]@{ Group = "Dataset";    Key = "border_dataset";           Name = "border-sensitive dataset path" },
