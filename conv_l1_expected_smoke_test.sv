class conv_l1_expected_smoke_test extends conv_test;
    `uvm_component_utils(conv_l1_expected_smoke_test)

    function new(string name = "conv_l1_expected_smoke_test", uvm_component parent = null);
